...
data = pd.read_csv(r'C:\Users\Kishl\OneDrive\Documents\OTT Hypothesis Testing An Analytical Study of Age Restriction and Ratings on Netflix vs Disney\data\processed\rating_analysis.csv') #Reading the data set in Python format
